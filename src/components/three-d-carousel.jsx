...
const keywords = [
  ...
  "525e56c2aa757d9efe3369cf20f592fd.jpg"
]
          ...
          {cards.map((imgUrl, i) => (
            ...
            >
              <motion.img
                ...
                layoutId={`img-${imgUrl}`}
                className="pointer-events-none w-full rounded-xl object-cover aspect-square border border-white/10 shadow-xl opacity-80"
      ...
      <AnimatePresence mode="sync">
        {activeImg && (
          <motion.div
            ...
            layout="position"
            onClick={handleClose}
            className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 m-5 md:m-36 lg:mx-[19rem] rounded-3xl backdrop-blur-sm"
